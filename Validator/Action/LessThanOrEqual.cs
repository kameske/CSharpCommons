...
namespace Commons
{
    public static partial class Validator
    {
        ...
        /// <paramref name="target"/>が<paramref name="limit"/>超過の場合
        /// </exception>
        public static void ValidateLessThanOrEqual<T>(IComparable<T> target, T limit,
        ...
        /// <summary>
        /// <see cref="ValidateLessThanOrEqual{T}"/>を実行する<see cref="Action"/>を返す。
        /// </summary>
        /// <param name="target">対象</param>
        ...
        /// </param>
        /// <returns><see cref="ValidateLessThanOrEqual{T}"/>実行<see cref="Action"/></returns>
        public static Action LessThanOrEqual<T>(IComparable<T> target, T limit,
            Func<Exception>? funcMakeException)
            => () => ValidateLessThanOrEqual(target, limit, funcMakeException);
    }
}