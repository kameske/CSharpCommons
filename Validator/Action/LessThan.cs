...
namespace Commons
{
    public static partial class Validator
    {
        ...
        /// <paramref name="target"/>が<paramref name="limit"/>以上の場合
        /// </exception>
        public static void ValidateLessThan<T>(IComparable<T> target, T limit,
        ...
        /// <summary>
        /// <see cref="ValidateLessThan{T}"/>を実行する<see cref="Action"/>を返す。
        /// </summary>
        /// <param name="target">対象</param>
        /// <param name="limit">上限</param>
        /// <param name="funcMakeException">
        ...
        /// </param>
        /// <returns><see cref="ValidateLessThan{T}"/>実行<see cref="Action"/></returns>
        public static Action LessThan<T>(IComparable<T> target, T limit,
            Func<Exception>? funcMakeException)
            => () => ValidateLessThan(target, limit, funcMakeException);
    }
}